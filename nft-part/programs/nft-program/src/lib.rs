...
declare_id!("9uJ8yGTieFKj2f3XixAfuBAdFmavEoVNgCZgkcK56KrJ");
...
pub mod nft_program {
    ...
    pub fn create_single_nft(
        ...
        mint_to(
            ...
            1, // 1 token - Для Master Edition нужен ровно один токен
        )?;
    ...
    pub fn create_large_nft_collection(
        ctx: Context<CreateNFT>,
        id: u64,
        name: String,
        symbol: String,
        ...
        mint_to(
            ...
            supply, // Указываем нужное количество токенов
        )?;
        ...
        // Для большой коллекции НЕ создаем Master Edition

        msg!("Created large NFT collection successfully");
