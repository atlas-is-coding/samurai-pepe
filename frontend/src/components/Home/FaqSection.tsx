...
export function FaqSection() {
  ...
  const faqItems: FaqItem[] = [
    ...
    },
    {
      ...
      answer: "To be eligible for $SPPE tokens, you need to purchase one of our Samurai Pepe NFTs. Here's how it works:\n\n• Kōjō (Common) NFT: Grants 5,000 points.\n• Daimyō (Rare) NFT: Grants 15,000 points.\n• Shōgun (Legendary) NFT: Grants 50,000 points.\n\nYou can purchase Kōjō and Daimyō NFTs directly. However, to mint a Shōgun NFT, you must already own both a Kōjō and a Daimyō NFT.\n\nOnce you've acquired your NFT(s), you'll receive points in your personal account, which can later be swapped for $SPPE tokens. These tokens will be tradable on major exchanges, including our own Samurai Pepe Exchange, as well as platforms like Binance, Coinbase, Kraken, and Bybit.\n\nThe exact date for swapping points into tokens and the token listing will be announced on our official channels. Remember, holding multiple NFTs means you're eligible for multiple token and point allocations!"
    },
    {
